require Record
Record.defrecord(:r_avro_value, :avro_value, type: :undefined, data: :undefined)
...
Record.defrecord(:r_avro_enum_type)
...
Record.defrecord(:r_avro_array_type)
...
Record.defrecord(:r_avro_union_type)
...
#         , custom    = []              :: [avro:custom_prop()]
#         }).
Record.defrecord(:r_avro_fixed_type)
